...
{
    console.log('StartCreationSession here');
	    ...
	    onSuccess: function(transport)
		{
	      if ( transport.responseText )
	      {
	        ...
	        elAvailibility.hide();
	      	...
	      	{
				elAvailibility.html('<img class="green_check" src="https://store.cloudflare.steamstatic.com/public/shared/images/joinsteam/icon_check.png?v=1" > Available');
